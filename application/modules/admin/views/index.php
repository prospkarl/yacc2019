        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="card card-stats">
                ...
                <div class="card-footer ">
                    <hr>
                    <div class="stats">
                        <i class="fa fa-info"></i> Overall Registration
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="card card-stats">
                ...
                <div class="card-footer ">
                    <hr>
                    <div class="stats">
                        <i class="fa fa-info"></i> Registrations Today
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"> Camper List</h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="table-campers" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Nick Name</th>
